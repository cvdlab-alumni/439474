...
modello=COLOR([1.39,1.21,0.94])(STRUCT([cap,colonnati,tetto,cornicione,bordoncino,front,bordoncino2,bordoncino3,t,triangolo2,cubi,cubi2]))
c1=CUBOID([107,158,0])
...
tempietto2=COLOR([1.39,1.21,0.94])(T([1,2])([160,140])(tempietto2))
...
modello=STRUCT([s,struttura1,rov1,rov2,rov3,mod,tetto1,tetto2,tetto3,tetto4,tetto5,tempietto2,COLOR(GREEN)(CUBOID([200,200,0]))])

#albero
tronco=COLOR([.5,.25,0])(CYLINDER([1,4])(32))
testa=T(3)(4)(JOIN([MAP(circle(3))(INTERVALS(2*PI)(20)),MK([0,0,10])]))
albero1=STRUCT([tronco,testa])
testax=STRUCT([testa])
for i in range(9) :
	testax=STRUCT([testax,T(3)(4+i)(JOIN([MAP(circle(3-0.22*i))(INTERVALS(2*PI)(20)),MK([0,0,10-i])]))])
testax=COLOR([0,0.3,0])(testax)
albero2=T([1,2])([10,20])(STRUCT([tronco,testax]))

alberi=STRUCT(NN(14)([T(2)(11),albero2]))

#casetta
cubo=CUBOID([1,1,1])
porta=CUBOID([0.25,0.5,0.5])
porta=T([1,2])([0.75,0.25])(porta)
sotto=DIFF([cubo,porta])
finestra=CUBOID([0.25,0.25,0.25])
f1=finestra
f2=finestra
f1=T([1,2,3])([0.75,0.625,0.625])(f1)
f2=T([1,2,3])([0.75,0.125,0.625])(f2)
sotto=DIFF([sotto,f2,f1])
a=MK([0,0,1])
b=MK([0,1,1])
c=MK([1,0,1])
d=MK([1,1,1])
h1=MK([0,0.5,1.5])
h2=MK([1,0.5,1.5])
tetto=COLOR(RED)(JOIN([a,b,c,d,h1,h2]))
casa=STRUCT([sotto,tetto])
...
p2=MK([0,0,0.5])
p3=MK([0.125,0.25,0])
p4=MK([0.125,0.25,0.5])
bho=COLOR(BLACK)(JOIN([p1,p2,p3,p4]))
bho=T([1,2])([2,1.25])(bho)
com=STRUCT([casa,bho])
cil=CUBOID([0.25,0.2,0.38])
cil=T([1,2,3])([1.4,1.1,1])(cil)
fine=STRUCT([com,cil])
fine=T([1,2])([40,10])(S([1,2,3])([6,6,6])(R([1,2])(PI/2)(T([1,2])([-1,-1])(fine))))
casette=STRUCT(NN(3)([T(1)(20),fine]))

#tavolo con sedie
piano =CUBOID([2,1,0.15])
gamba=CUBOID([0.1,0.1,0.8])
g1=gamba
g2=T([1])(1.9)(gamba)
g3=T([2])(0.9)(gamba)
g4=T([1,2])([1.9,0.9])(gamba)
piano=T([3])(0.8)(piano)
tavolo=COLOR(RED)(STRUCT([g1,g2,g3,g4,piano]))

pianos =CUBOID([0.6,0.6,0.1])
schienale =CUBOID([0.6,0.7,0.1])
schienale=R([2,3])(PI/2)(schienale)
gambas=CUBOID([0.05,0.05,0.6])
g5=gambas
g6=T([1])(0.55)(gambas)
g7=T([2])(0.55)(gambas)
g8=T([1,2])([0.55,0.55])(gambas)
pianos=T([3])(0.6)(pianos)
schienale=T([1,2,3])([0,0.6,0.7])(schienale)
sedia=STRUCT([g5,g6,g7,g8,pianos,schienale])
s1=T([1,2])([0.7,0.8])(sedia)
completo=T([1,2])([1,1])(STRUCT([tavolo,s1]))
s2=T([1,2])([2.3,1.3])(R([1,2])(PI)(sedia))
s3=T([1,2])([1,1.2])(R([1,2])(PI/2)(sedia))
s4=T([1,2])([3,1.8])(R([1,2])(PI*3/2)(sedia))
tavolocompleto=T([1,2])([150,60])(S([1,2,3])([3,3,3])(STRUCT([completo,s2,s3,s4])))
tavolocompleto2=T([1,2])([160,65])(S([1,2,3])([3,3,3])(STRUCT([completo,s2])))
tavolocompleto3=T([1,2])([140,70])(S([1,2,3])([3,3,3])(STRUCT([completo,s3])))
tavolocompleto4=T([1,2])([150,80])(S([1,2,3])([3,3,3])(STRUCT([completo,s4])))

#lampione

stecca=CYLINDER([0.15,5])(50)

cerchio=T(3)(5.3)(JOIN([MAP(circle(0.5))(INTERVALS(2*PI)(20))]))
cerchio2=T(3)(4.8)(JOIN([MAP(circle(0.15))(INTERVALS(2*PI)(20))]))
c=JOIN([cerchio2,cerchio])
palo=STRUCT([stecca,c])
x1=MK([0.6,0.6,6.3])
x2=MK([-0.6,0.6,6.3])
x3=MK([0.6,-0.6,6.3])
x4=MK([-0.6,-0.6,6.3])
x5=MK([0,0,6.8])
x=JOIN([x1,x2,x3,x4])
x11=COLOR(BLACK)(JOIN([x,x5]))
x22=COLOR(YELLOW)(JOIN([x,cerchio]))
palo=STRUCT([x11,palo,x22])
p1=T([1,2,3])([55,60,13])(S(3)(1.2)(palo))
p2=T(2)(20)(p1)
p3=T(2)(20)(p2)
p4=T(2)(20)(p3)
p5=T(2)(20)(p4)
px=STRUCT([p1,p2,p3,p4,p5])
py=T(1)(37)(px)

#strada
strada1=T([1,2])([50,15])(CUBOID([80,7,0]))
strada2=T([1,2])([130,15])(R([1,2])(PI/4)(CUBOID([60,7,0])))
strada3=T([1,2])([137,56])(CUBOID([35,35,0]))
street=STRUCT([strada1,strada2,strada3])
VIEW(STRUCT([street,px,py,modello,alberi,casette,tavolocompleto,tavolocompleto2,tavolocompleto3,tavolocompleto4]))